...
export class BottomNavigationComponent implements OnInit {
  ...
  initComponent() {
    ...
    this.schoolService
      .getCourseButtons()
      .subscribe((data) => (this.courseButtons = data));
    this.schoolService
      .getBookButtons()
      .subscribe((data) => (this.bookButtons = data));
    this.schoolService
      .getTSCompilerButtons()
      .subscribe((data) => (this.tsCompilerButtons = data));
    this.schoolService
      .getWebCenterButtons()
      .subscribe((data) => (this.webCenterButtons = data));
    this.schoolService
      .getSASSCompilerButtons()
      .subscribe((data) => (this.sassCompilerButtons = data));
    this.schoolService
      .getLessonsInputButtons()
      .subscribe((data) => (this.lessonsInputButtons = data));
  }
